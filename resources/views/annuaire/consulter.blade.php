            ...
            <div class="breadcumb-content">
                ...
                <div class="breadcumb-menu-wrap">
                    <ul class="breadcumb-menu">
                        ...
                        <li><a href="{{route('appartenir')}}">Appartenir</a></li>
                        <li>{{$pageTitle}}</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="title-area text-center">
                        ...
                        <p class="sec-text">Découvrez les organisations de notre réseau professionnel</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="filter-form bg-white p-4 rounded shadow-sm">
                        <form method="GET" action="{{ route('annuaire.consulter') }}" class="row g-3">
                            <div class="col-md-6">
                    ...
                    <div class="col-12">
                        <div class="text-center py-5">
                            <div class="empty-state">
                                ...
                                <a href="{{ route('annuaire.consulter') }}" class="btn btn-primary">
