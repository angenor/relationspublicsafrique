<template>
    <div @click.stop="openFileFor"  class="cursor-pointer lg:h-40 w-44 absolute object-cover left-7 -top-[20%]" >
...
<!--            <Pin class="h-6 w-6 text-red-500 relative"> </Pin>-->
         ...
         <img   :src="avatarFileUrl" class="lg:h-40 w-44 object-cover rounded-xl shadow-xl ring ring-sky-800 bg-white/90" alt="">
    </div>
...
const onFileChangeAvatar =async (e) => {
   ...
   const  imageUrl = await saveAvatar(file)
    ...
    emiter('onAvatarFileSelected',imageUrl)
}
