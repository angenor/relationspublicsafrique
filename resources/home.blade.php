...
{{--                                THE <span>WORLD’S #1 ONLINE</span> EDUCATION--}}
                                <p class="hero-text animated text-white">{!! $slider->resume !!}</p>
            ...
            <div class="row vs-carousel wow fadeInUp" data-wow-delay="0.4s" data-slide-show="3" data-lg-slide-show="2" data-md-slide-show="2" data-sm-slide-show="2" data-center-mode="true" data-xl-center-mode="true" data-ml-center-mode="true">
                <div class="col-sm-6 col-xl-4">
                    <div class="feature-style1">
                        ...
                        <h4 class="feature-title"><a href="{!! WT::getContent('block_annuaire_accueil')->link??'' !!}" class="text-inherit">{!! WT::getContent('block_annuaire_accueil')->name??'' !!}</a></h4>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="feature-style1">
                        ...
                        <h4 class="feature-title"><a href="{!! WT::getContent('block_annuaire_accueil')->link??'' !!}" class="text-inherit">{!! WT::getContent('block_actualité_accueil')->name??'' !!}</a></h4>
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="feature-style1">
                        ...
                        <h4 class="feature-title"><a href="#" class="text-inherit">{!! WT::getContent('block_actualité_accueil')->name??'' !!}</a></h4>
                        <p class="feature-text">{!! WT::getContent('block_actualité_accueil')->content??'' !!}</p>
                    </div>
                </div>
  ...
  ==============================-->
    <section class="overflow-hidden space-top space-extra-bottom">
        ...
        <div class="container">
            <div class="row gx-80">
                @php
                   $dateEvent = $evenements[0]->created_at->format('d/m/Y')??'' ;
                    ...
                    <div class="col-lg-6 col-xxl-5 pb-3 pb-lg-0 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="picture-box1">
                            ...
                            <div class="countdown-style1">
                                <span class="countdown-title">{{$evenements[0]->name??''}}</span>
                                <ul class="countdown-active" data-end-date="{!! $dateEvent !!}}">
{{--                                <ul class="countdown-active" data-end-date="01/12/2024">--}}
                                ...
                                <a href="{{$evenements[0]->link}}" class="link-btn">Découvrire <i class="fas fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                @endif
                    ...
                    @foreach($evenements->slice(1) as $evenement)
                        <div class="event-style1">
                            <div class="event-date">
                                <span class="day">15</span><span class="month">Mar, 2023</span></div>
                ...
                @foreach($blogs as $blog)
                    <div class="col-lg-6">
                        <div class="vs-blog blog-style1">
                            <div class="blog-img">
                                <img class="w-100" src="{{$blog->img}}" alt="Blog Img">
                            </div>
